...
db = client["amazon_search_10_api"]
...
def search_products(request: Request, body: SearchRequest) -> dict:
    ...
    response = requests.get(search_url, headers=HEADERS, cookies=cookies, impersonate="chrome99")
...
if __name__ == "__main__":
    uvicorn.run("main:app", host="51.222.244.92", port=1917, reload=True)
